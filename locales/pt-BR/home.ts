const pt = {
  ...
  "cards": [
    {
      "id": 1,
      "text": "Trabalho incrível, tu é monstro demais. Parabéns irmão 🐨"
    },
    ...
    {
      "id": 5,
      "text": "trabalho surreal, fico mais impressionado a cada trampo!!"
    },
    {
      "id": 6,
    ...
    {
      "id": 9,
      "text": "Estou acompanhando você pra depois fazer uma desse naip"
    },
